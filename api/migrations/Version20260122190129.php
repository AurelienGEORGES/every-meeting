 ...
 */
final class Version20260122190129 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE to_do_list_item (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, priority SMALLINT DEFAULT NULL, deadline DATETIME DEFAULT NULL, done SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, difficulty SMALLINT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_B3FB63A6A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, username VARCHAR(30) NOT NULL, created_at DATE DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
