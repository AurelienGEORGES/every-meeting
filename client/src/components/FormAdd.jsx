...
const FormAdd = ({ addTodo }) => {
    ...
    const handlePriorityDown = () => {
        if (parseInt(selectedPriority) > 0) {
    ...
    const handleDifficultyDown = () => {
        if (parseInt(selectedDifficulty) > 0) {
    ...
    return (
        ...
        <>
            <div className='flex justify-center m-3'>
                <button onClick={openModal} className='text-xl text-white bg-nav hover:bg-blue-200 hover:text-nav px-3 py-1 rounded-full' data-btn-add="add">
                ...
                <div className='todo m-1'>
                    <form className='max-w-xl' onSubmit={handleSubmit} >
                        ...
                        <div className='flex-wrap'>
                            <div className='mt-2'>
                                <div className='flex flex-col'>
                                    <div>
                                        <label htmlFor="deadlineInput" className='text-xl text-gray-600'>Sélectionnez la date butoire :</label>
                                    </div>
                                    <div>
                                        <input
                                            type="datetime-local"
                            ...
                            <div className='flex justify-center my-3'>
                                <div>
                                    <button type='submit' className='text-xl text-gray-600 
                        bg-orange-400 hover:bg-yellow-400 border-gray-600 border-4 p-3 rounded-xl'>
                                        Je me lance!
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className='flex justify-end mt-3'>
                            <button onClick={closeModal} className='text-xl text-gray-600 underline decoration-orange-500' id="btn-close-modal-add">Fermer le formulaire</button>
                        </div>
                    </form>
                </div>
            </Modal>
