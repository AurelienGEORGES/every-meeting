    ...
    return (
        <header className='relative'>
            <nav className="md:sticky md:top-0 md:left-0 md:h-screen bg-nav sticky top-0 flex flex-col">
                ...
                <ul className={`md:flex md:flex-col md:h-full md:space-y-4 ${isOpenBurger ? 'flex flex-col items-center h-full' : 'hidden'}`}>
                    <li className="text-white text-2xl p-2 hover:underline">
                        <NavLink to="/" title="page d'accueil">
                            {(isOpen && !isOpenBurger) ? <img src={navhome} alt="maison" className="img-fluid"/> : 'Accueil'}
                        </NavLink>
                    </li>
                    <li className="text-white text-2xl p-2 hover:underline">
                        <NavLink to="/to-do-list" title="page de la ToDo liste">
                            {(isOpen && !isOpenBurger) ? <img src={navtodolist} alt="crayon" className="img-fluid"/>
                                : 'ToDo Liste'}
                        </NavLink>
                    </li>
                    <li className="text-white text-2xl p-2 hover:underline">
                        <NavLink to="/kanban"  title="page du Kanban" data-cy="kanbanLink">
                            {(isOpen && !isOpenBurger) ? <img src={navkanban} alt="tableau" className="img-fluid"/> : 'Kanban'}
                        </NavLink>
                    </li>
                    <li className="text-white text-2xl p-2 hover:underline">
                        <NavLink to="/chat"  title="page du Chat">
                            {(isOpen && !isOpenBurger) ? <img src={navchat} alt="message" className="img-fluid"/> : 'Chat'}
                        </NavLink>
                    </li>
                    <li className="text-white text-2xl p-2 hover:underline">
                        <NavLink to="/planning" title="page du Planning">
                            {(isOpen && !isOpenBurger) ? <img src={navplanning} alt="calendrier" className="img-fluid"/> : 'Planning'}
                        </NavLink>
                    </li>
                    <li className="text-white text-2xl p-2 hover:underline">
                        <NavLink to="/scrum"  title="page du Scrum">
                            {(isOpen && !isOpenBurger) ? <img src={navscrum} alt="carnet" className="img-fluid"/> : 'Scrum'}
                        </NavLink>
                    </li>
                </ul>
            </nav>
