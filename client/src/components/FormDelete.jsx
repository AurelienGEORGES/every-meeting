...
const FormDelete = ({ id, deleteTodo }) => {
    ...
    return (
        <button type='button' className='text-xl text-white bg-king hover:bg-purple-200 hover:text-king px-3 py-1 rounded-full' onClick={() => handleDelete(id)} data-cy="delete-btn" data-id={id}>
